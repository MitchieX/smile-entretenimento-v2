...
if(isset($_POST['email'])) {
    ...
    $email_subject = "(INDOOR) Solicitação de Orçamento";
...
echo "<script>alert("Obrigado! Em breve entraremos em contato");window.location.assign('http://www.sousmile.com.br/');</script>";
